...
Feature: Extended Markdown display and behaviour attributes
  In order to control the display and behaviour of Extended Markdown code blocks
  As a teacher
  I need to be able to combine the colon-separated attributes documented in the
  README with highlighted or interactive Extended Markdown code blocks, for
  different languages
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | description | extendedmarkdownattrsdemo |
